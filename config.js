...
global.botName = 'Njabulo-Jb'; // Bot Name
global.botVersion = '2.0.2';
global.botPic = 'https://files.giftedtech.web.id/file/gifted-md.jpg'; // Can use path, can also use link
global.botToken = '8577249404:AAEYRyE8OzEAcPr07kM72JAC-LHoKSTdkVg'; // Replace With Your Bot Token (Get it from BotFather)
global.ownerUsername = 'NjabuloJf'; // Replace With Your Telegram Username(For Bot Owner)
...
global.footer = '*Powered by Njabulo Jb*';
...
global.giftedKey = 'NjabuloJf'; // Gifted Api Key
...
global.giftedRepo = "https://github.com/NjabuloJf/telegram-bot";
global.giftedApiRepo = "https://api.github.com/repos/NjabuloJf/telegram-bot";
